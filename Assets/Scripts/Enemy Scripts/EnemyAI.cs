...
public class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField]
    public float movementRate; // How long it moves

    [SerializeField]
    public float movementPause; // How long it slows down
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.tag == "Laser")
        {
            ...
            player.GetComponent<PlayerAgent>().HandleShootEnemy();
        ...
        else if (other.tag == "Player")
        {
            ...
            other.GetComponent<PlayerAgent>().HandleHitEnemy();
            if (player != null)
            {
